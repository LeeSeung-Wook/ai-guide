...
- [ ] **T-2.1 회원가입 로직 구현**
  ...
  - [ ] `join-form.mustache` 템플릿 구현 (회원가입 폼)
...
- [ ] **T-5.3 UI/UX 및 레이아웃 정리**
  - [ ] Mustache partials를 이용한 헤더/푸터 공통화
  - [ ] Bootstrap 등을 활용한 반응형 레이아웃 보정
- [ ] **T-5.4 통합 테스트 및 최종 검수**
